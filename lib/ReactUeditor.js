...
function (_React$Component) {
  ...
  function ReactUeditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "initEditor", function () {
      ...
      _this.ueditor.ready(function () {
        ...
        if (defaultValue) {
          _this.ueditor.setContent(defaultValue);
    ...
    _this.content = props.value || props.defaultValue || ''; // 存储编辑器的实时数据，用于传递给父组件
  ...
  _createClass(ReactUeditor, [{
    ...
    value: function componentDidMount() {
      ...
      if (!ueditorPath) {
        ueditorPath = 'https://jzhu1224.github.io/react-ueditor/vendor/ueditor';
      }
...
_defineProperty(ReactUeditor, "propTypes", {
  ...
  ueditorPath: _propTypes.default.string,
